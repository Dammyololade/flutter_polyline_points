...
void main() {
  test('get list of coordinates from two geographical positions', () async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(Constants.API_KEY, PointLatLng(6.5212402, 3.3679965), PointLatLng(6.595680, 3.337030), travelMode: TravelMode.driving);
